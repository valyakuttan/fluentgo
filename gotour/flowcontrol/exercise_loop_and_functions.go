...
matter what the input. To begin with, repeat the calculation 10 times and print each
z along the way. See how close you get to the answer for various values
...
(or only changes by a very small amount). See if that's more or fewer than 10
...
the derivative of z², to scale how much we adjust z by how quickly z² is changing.
